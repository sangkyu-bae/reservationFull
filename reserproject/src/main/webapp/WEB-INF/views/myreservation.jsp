...
<head>
    ...
    <!-- <script type="text/javascript" src ="${path }/reservation.v1.5/resevation-html-base/js/mainBooking.js"></script> -->
	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<a href="logout" class="btn_my"> <span title="내예약" class="viewReservation"></span> </a>
			</header>
		</div>
		<hr>
		<div class="ct">
		...
		<script type="text/javascript" src ="${path }/reservation.v1.5/resevation-html-base/js/actionmyReservation.js"></script>
		<script type="text/javascript">
    	var userEmail='<%=(String)session.getAttribute("emailValue")%>';
    	if(userEmail!=null){
    		var getTemplate=new GetTemplate(userEmail);
    	}
    </script>
	</html>