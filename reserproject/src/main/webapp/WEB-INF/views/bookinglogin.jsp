...
<html lang="ko" class="no-js" >
   ...
   <body class="biz  ko" >
      ...
      <app>
         ...
         <!---->
        <div style="font-size:20px; text-align:center;font-weight:bold;"> ${errorMessage}</div>
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  <h1 class="login_header"> <a href="index"  class="nbooking_logo spr_bi txt_logo" > <span translate="CM-NBOOKING">네이버 예약</span> </a> </h1>
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" method="post"action="checkEmail">
         ...
         <translater-modal style="display: none;">
            <div class="sel_box_on">
          	...
          	<script type="text/javascript" src ="${path }/reservation.v1.5/resevation-html-base/js/actionBooking.js"></script>
   </body>
</html>