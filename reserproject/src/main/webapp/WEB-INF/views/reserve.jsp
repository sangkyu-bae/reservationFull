                ...
                <div class="section_booking_form">
                    <div class="booking_form_wrap">
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal" action="addreserve" method="post">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div class="inline_control"> <input type="text" name="reservationName" id="name" class="text" placeholder="네이버" maxlength="17"> </div>
                                </div>
                                ...
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control"> <input type="email" name="reservationEmail" id="email" class="email" value="" placeholder="crong@codesquad.kr" maxlength="50"> </div>
                                </div>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a href="javascript:;" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
