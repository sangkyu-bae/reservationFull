...
<head>
	...
	-->
	<link href="${path}/reservation.v1.5/resevation-html-base/style.css" rel="stylesheet" >
    <!--<script type="text/javascript" src ="${path }/reservation.v1.5/resevation-html-base/js/mainDetail.js"></script>-->
...
<body>
    <div id="container">
        <div class="header fade">
            <header class="header_tit">
                <h1 class="logo">
                    <a href="index" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
                    <a href="index" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
                </h1>
        ...
        <div class="ct main">
            <div>
                ...
                <div class="section_btn"> <button type="button" class="bk_btn" onclick="clickReserve();"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
                <div class="section_review_list">
                    ...
                    <a class="btn_review_more" onclick="getDetailId();"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
    ...
    <script type="text/javascript" src ="${path }/reservation.v1.5/resevation-html-base/js/actionDetail.js"></script>
   
    <script type="my-template" id="tabcontent">
					...
					{{#if comments}}
						...
						{{else}}
						   <li class="list_item">
							<div class="review_area">                                 
                                            <h4 class="resoc_name"></h4>
                                            <p class="review">코멘트가 등록되지 않았습니다!</p>
                               </div>
							 </li>
						{{/if}}
	</script>
